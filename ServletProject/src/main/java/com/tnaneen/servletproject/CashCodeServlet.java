 ...
 * @author bo
 */
@WebServlet(name = "CashCodeServlet", urlPatterns = {"/CashCodeServlet"})
public class CashCodeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           ...
           dbHandler.addCash(code, cash);
           CashCode cc=new CashCode(code, cash);
