    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null)
        {
            ...
            CartItem selectedProduct = null;    
                ...
                if (selectedProduct != null)
                {
                    ...
                    shoppingCart.add(selectedProduct);
                      System.out.println("ProductID = "+ selectedProduct.getProductId() + ">> Q="+selectedProduct.getQuantity());
            ...
            //////////////////////// b.  if he  don't have a cart    CREATE it
                ...
                System.out.println("+++++++++++++++++++++++++++++");
                System.out.println(newShoppingCart);
            }
        ...
        ///////////// B. if user is NOT logged in
            ...
            response.sendRedirect("Home.jsp?cartlog=true");
